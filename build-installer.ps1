...
& jpackage `
  ...
  --main-jar editeurPanovisu-3.1.0-SNAPSHOT.jar `
...
@echo off
cd /d "%~dp0app"
start "" "%~dp0runtime\bin\javaw.exe" -Dfile.encoding=UTF-8 --enable-preview --enable-native-access=ALL-UNNAMED -Xms512m -Xmx2048m -jar "editeurPanovisu-3.1.0-SNAPSHOT.jar"
'@
